...
public class PracticeTask_HTTP {
    ...
    Some of the codes and their meanings are listed below:
      ...
      */
        System.out.println("Enter the status code to learn what it means:");
        int statusCode = new Scanner(System.in).nextInt();

        String message = (statusCode == 200) ? "OK"
                ...
                : "Invalid Status Code. Check it and try again...";

        System.out.println("\"" + statusCode + "\" means : " + message);
    }
}
